...
from models.unet import ImageUNetLNMixupLSTM as Net
...
cfg.exp_name = 'final_fold5_mix_480_b2_dur32_deep_lstm_noreg'
...
# cfg.model.resume_exp = 'stage3_ball018_b2_aug_clip_no_warmup_0918'
...
cfg.ema_start_epoch = 0
cfg.awp_start_epoch = 500
        ...
        for name, param in self.model.named_parameters():
            if param.requires_grad and param.grad is not None and self.adv_param in name:
                ...
                if norm_grad != 0 and not torch.isnan(norm_grad):
                    ...
                    param.data.add_(grad, alpha=(
                        self.adv_lr * (norm_data + e) / (norm_grad + e)))
